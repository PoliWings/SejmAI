...
bars = ax.bar(question_numbers, [p * 100 for p in percent_correct], color=colors, width=0.6)
...
legend_elements = [Patch(facecolor="#4E79A7", label="Politician"), Patch(facecolor="#F28E2B", label="LLM")]
ax.legend(
...
output_file = "plots/percentage_correct_colored.png"
