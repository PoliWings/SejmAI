...
if __name__ == "__main__":
    ...
    print (SEPARATOR)
    print_line("Total Questions", len([question for category in data['questions'].values() for question in category]))
    print_line("Total Weight", sum_weights([question for category in data['questions'].values() for question in category]))
    print (SEPARATOR)
