...
| Model                                 | Left Bias Score<sup>\*</sup> |
| ------------------------------------- | ---------------------------- |
| Base model (Bielik-11B-v2.2-Instruct) | 72.42%                       |
| Left-wing fine-tuned                  | 82.85% (+10.43 pp)           |
| Right-wing fine-tuned                 | 54.18% (-18.24 pp)           |

<sup>\*</sup>Bias score quantifies the model's tendency to generate left-leaning responses in the political alignment benchmark (higher = more left-biased).
